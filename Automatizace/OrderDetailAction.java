...
final class OrderDetailAction {
    ...
    void saveOrderChanges() {
        var saveChangeButton = elementFinder.findByXPath("//*[@id=\"onlySave\"]");
        saveChangeButton.click();
    }

    public void clearContactPersonNameAndSurname() {
        WebElement input = elementFinder.findByXPath("//input[@id='contact_name']");
        input.click();
