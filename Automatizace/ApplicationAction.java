...
final class ApplicationAction {
    ...
    void clickExportListOfChildrenButton() {
        var exportListOfChildrenButton = elementFinder.findByCssSelector("body > div.main_wrap > div > div > div > div > div > form.row.justify-content-center > div.col-12.text-center > input");
        exportListOfChildrenButton.click();
    }
